...
from data.load_test_data import loadingTestData, loadingTestChikuseiData
...
def main():
    ...
    train_parser.add_argument("--batch_size", type=int, default=2, help="batch size, default set to 64")
...
def train(args):
    ...
    if args.model_title == "VolFormer":
        net = General_VolFormer(n_subs=args.n_subs, n_ovls=args.n_ovls, n_colors=colors, n_blocks=args.n_blocks, n_feats=args.n_feats,
